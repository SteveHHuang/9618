## Explain how a new element can be added to the queue if it is implemented using two stacks.[4] 
> s23 33 Q11c
...
>s23 33 Q12a
	...
	- A process using a function or procedure calls itself. 
	- A recursive process must have a base case 
	- There must also be a general case where the recursive call takes place.


## Explain the reasons why a stack is a suitable Abstract Data Type (ADT) to implement recursion. [3] 
>w21 31 Q10b
...
## Explain why the properties are private.[2] 
>w18 41 Q5a
...
## OOP terms definitions. 
>s23 32 Q4, w22 32 Q10a
...
## Define the term exception handling[1] 
>w23 31
